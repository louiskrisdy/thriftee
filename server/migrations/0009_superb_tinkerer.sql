ALTER TABLE "email_tokens" RENAME COLUMN "expires_at" TO "expires";--> statement-breakpoint
/* 
...
ALTER TABLE "email_tokens" DROP COLUMN "created_at";--> statement-breakpoint
ALTER TABLE "email_tokens" DROP COLUMN "updated_at";